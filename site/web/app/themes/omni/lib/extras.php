				...
				<?php if ( $the_query->have_posts() ) : ?>
					...
					<?php while ( $the_query->have_posts() ) : $the_query->the_post(); $i++; ?>
						...
						<div class="carousel-item <?php echo $active; ?>">
							<div class="img-background" style="background-image: url(<?php the_post_thumbnail_url( 'full' ); ?>);"></div>
<!-- 							<h2><?php the_title(); ?></h2> -->
							<a href="<?php the_permalink(); ?>" class="btn btn-secondary view-project">View Project</a>
						</div>
					<?php endwhile; ?>
